...
Source0  : http://download.redis.io/releases/redis-6.0.5.tar.gz
...
%prep
%setup -q -n redis-6.0.5
cd %{_builddir}/redis-6.0.5
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591736784
...
cp %{_builddir}/redis-6.0.5/COPYING %{buildroot}/usr/share/package-licenses/redis-native/a19e8c78250e9af2bffc5c60e21478c392662dae
cp %{_builddir}/redis-6.0.5/deps/hiredis/COPYING %{buildroot}/usr/share/package-licenses/redis-native/e9c1298de98016808910005a33de3a5f25dce05e
cp %{_builddir}/redis-6.0.5/deps/jemalloc/COPYING %{buildroot}/usr/share/package-licenses/redis-native/32366cf8c310f3ab4c264217764166f95f030e00
cp %{_builddir}/redis-6.0.5/deps/lua/COPYRIGHT %{buildroot}/usr/share/package-licenses/redis-native/a6efc4d11f332f4843bc25b557c6bf3e5ef51458
%make_install

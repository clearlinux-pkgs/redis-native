...
Source0  : https://download.redis.io/releases/redis-6.2.6.tar.gz
...
%prep
%setup -q -n redis-6.2.6
cd %{_builddir}/redis-6.2.6
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633367126
...
cp %{_builddir}/redis-6.2.6/COPYING %{buildroot}/usr/share/package-licenses/redis-native/44e5add5829f86c049fd08dffce57f00da52fd1f
cp %{_builddir}/redis-6.2.6/deps/hdr_histogram/COPYING.txt %{buildroot}/usr/share/package-licenses/redis-native/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/redis-6.2.6/deps/hdr_histogram/LICENSE.txt %{buildroot}/usr/share/package-licenses/redis-native/1f3f949bd5fdef93522f7eaad5a31dd1cca02ca1
cp %{_builddir}/redis-6.2.6/deps/hiredis/COPYING %{buildroot}/usr/share/package-licenses/redis-native/e9c1298de98016808910005a33de3a5f25dce05e
cp %{_builddir}/redis-6.2.6/deps/jemalloc/COPYING %{buildroot}/usr/share/package-licenses/redis-native/32366cf8c310f3ab4c264217764166f95f030e00
cp %{_builddir}/redis-6.2.6/deps/lua/COPYRIGHT %{buildroot}/usr/share/package-licenses/redis-native/a6efc4d11f332f4843bc25b557c6bf3e5ef51458
%make_install
